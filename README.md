...
C:\Users\4261213885>dotnet new list
Esses modelos correspondem à sua entrada:

Nome do modelo                                       Nome Curto                  Idioma      Tags
---------------------------------------------------  --------------------------  ----------  --------------------------
API Web do ASP.NET Core                              webapi                      [C#],F#     Web/Web API/API/Service
Aplicativo Blazor WebAssembly                        blazorwasm                  [C#]        Web/Blazor/WebAssembly/PWA
...
Aplicativo Web do ASP.NET Core (Model-View-Contr...  mvc                         [C#],F#     Web/MVC
...
C:\Users\4261213885>dotnet new console -n Calculadora -f net8.0
O modelo "Aplicativo do Console" foi criado com êxito.

Processando ações pós-criação...
Restaurando C:\Users\4261213885\Calculadora\Calculadora.csproj:
  Determinando os projetos a serem restaurados...
  C:\Users\4261213885\Calculadora\Calculadora.csproj restaurado (em 104 ms).
A restauração foi bem-sucedida.

C:\Users\4261213885>cd Calculadora

C:\Users\4261213885\Calculadora>

C:\Users\4261213885\Calculadora>cd..

C:\Users\4261213885>notepad Calculadora.csproj
'notepad' não é reconhecido como um comando interno
